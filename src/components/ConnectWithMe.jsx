        ...
        <section className="py-24 max-w-7xl mx-auto px-6 md:px-8" id="connect">
            <ScrollReveal>
                <div className="relative overflow-hidden rounded-2xl border border-neutral-200 dark:border-neutral-800 bg-neutral-50 dark:bg-neutral-900 p-12 md:p-20">
                    ...
                    <div className="absolute -bottom-20 -right-20 w-96 h-96 bg-primary/5 dark:bg-white/5 rounded-full blur-[100px] pointer-events-none" />
                    <div className="absolute -top-20 -left-20 w-64 h-64 bg-primary/5 dark:bg-white/5 rounded-full blur-[80px] pointer-events-none" />

                    <div className="relative z-10 flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
                        {/* Left: text content */}
                        <div className="flex-1 text-center lg:text-left">
                            <span className="inline-block text-black dark:text-white font-bold tracking-[0.3em] uppercase text-xs font-mono mb-4">
                                Let's Connect
                            </span>
