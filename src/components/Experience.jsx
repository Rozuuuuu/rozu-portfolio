            ...
            <ScrollReveal className="max-w-7xl mx-auto px-6 md:px-8">
                <div className="grid lg:grid-cols-3 gap-12">
                    <div>
                        ...
                        <p className="mt-6 text-neutral-500 dark:text-neutral-400 leading-relaxed">A decade of engineering excellence across diverse industries, from startups to enterprise-level architecture.</p>
                    </div>
