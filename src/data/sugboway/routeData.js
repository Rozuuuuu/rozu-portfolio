export const routes = [
  {
    route_id: "route_01b",
    route_code: "01B",
    route_name: "Sambag 1 to Pier 3 & 2 via Colon St.",
    description: "Sambag 1 (Private) to Pier 3 and 2 via Colon st.",
    has_aircon: false,
    stops: [
  ...
  },
  {
    route_id: "route_03b",
    route_code: "03B",
    route_name: "Mabolo to Colon via Jones Ave.",
    description: "Cebu Jeepneys - 03B route map mabolo to colon via jones ave.",
    has_aircon: false,
    stops: [
  ...
  },
  {
    route_id: "route_13c",
    route_code: "13C",
    route_name: "Talamban - Banilad - Ayala - Colon",
    description: "Talamban - Banilad - Ayala - Colon and vice versa",
    has_aircon: true,
    stops: [
