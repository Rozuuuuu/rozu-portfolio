                ...
                <section className="max-w-7xl mx-auto px-6 md:px-8 mb-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        {spotlight.map(({ id, icon, iconColor, title, subtitle, desc, img, imgAlt }) => (
                            <ScrollReveal key={id}>
                                <div className="bg-neutral-50 dark:bg-neutral-950 border border-neutral-200 dark:border-neutral-800 rounded-xl overflow-hidden shadow-md dark:shadow-black/40 group h-full flex flex-col">
                ...
                <section className="max-w-7xl mx-auto px-6 md:px-8 mb-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        {milestones.map(({ id, icon, title, subtitle, desc, img, imgAlt }) => (
                            <ScrollReveal key={id}>
                                <div className="bg-neutral-50 dark:bg-neutral-950 border border-neutral-200 dark:border-neutral-800 rounded-xl overflow-hidden shadow-md dark:shadow-black/40 group flex flex-col sm:flex-row h-full">
